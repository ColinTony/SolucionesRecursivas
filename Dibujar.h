...
void DibujarDisco(int n,int x,int y,int m);     // La funcion dibujara el disco
void BorrarDisco(int n,int x,int y,int m);      // Borrar Disco
void InitHanoi(int n);                          // Posicion inicial de la torre de hanoi
